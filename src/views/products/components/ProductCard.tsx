...
export default function ProductCard({ product, cartStore }: ProductCardProps) {
  ...
  return (
    <Link href={`/products/${product.id}`}>
      <div className="flex max-w-xs cursor-pointer flex-col justify-around gap-2 overflow-hidden rounded-lg border border-gray-200 bg-background p-4 transition-transform transform shadow-sm hover:shadow-lg w-48 h-96 relative">
